...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, LOWER,   SFT_T(KC_SPC), KC_LCTL,    RAISE,   LOWER,   KC_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      LCTL(KC_A), KC_ENT,     KC_LEFT,    KC_DOWN,    KC_RIGHT,   KC_PGUP,                   KC_P0,   KC_P4,   KC_P5,   KC_P6,   KC_ASTR, _______, \
      _______,    LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_PGDN, _______, _______, KC_DOT,  KC_P1,   KC_P2,   KC_P3,   KC_PLUS, _______, \
