...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______,    KC_DELT,    KC_BSPC,    KC_UP,      KC_HOME,    KC_END,                    KC_MINS, KC_P7,   KC_P8,   KC_P9,   KC_SLSH, KC_F12, \
      LCTL(KC_A), KC_ENT,     KC_LEFT,    KC_DOWN,    KC_RIGHT,   KC_SPC,                    KC_P0,   KC_P4,   KC_P5,   KC_P6,   KC_ASTR, _______, \
      _______,    LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_PGUP, KC_PGDN, _______, KC_DOT,  KC_P1,   KC_P2,   KC_P3,   KC_PLUS, _______, \
